...
import com.example.expensetracker.data.UpcomingPaymentData
import com.example.expensetracker.helper.UtcDateFormat
import com.example.expensetracker.isInDaysAfter
import com.example.expensetracker.isSameDay
...
import com.example.expensetracker.viewmodel.database.RecurrenceDatabase
import com.example.expensetracker.viewmodel.database.RecurringExpense
...
class UpcomingPaymentsViewModel(
    ...
    private fun getNextPaymentInMilliseconds(
        ...
        val nextPayment = Calendar.getInstance(TimeZone.getTimeZone("UTC+3"))
    ...
    private fun getNextPaymentDays(nextPaymentInMilliseconds: Long): Int {
        val todayInUTC =
            Calendar.getInstance(TimeZone.getTimeZone("UTC+3")).apply {
