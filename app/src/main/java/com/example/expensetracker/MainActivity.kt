...
import com.example.expensetracker.data.BottomNavigation
import com.example.expensetracker.data.Recurrence
import com.example.expensetracker.data.RecurringExpenseData
import com.example.expensetracker.security.BiometricPromptManager
import com.example.expensetracker.security.BiometricPromptManager.BiometricResult
import com.example.expensetracker.ui.RecurringExpenseOverview
import com.example.expensetracker.ui.SettingsScreen
import com.example.expensetracker.ui.customizations.ExpenseColor
import com.example.expensetracker.ui.editexpense.EditRecurringExpense
import com.example.expensetracker.ui.theme.ExpenseTrackerTheme
import com.example.expensetracker.ui.upcomingexpenses.UpcomingPaymentsScreen
import com.example.expensetracker.viewmodel.MainActivityViewModel
import com.example.expensetracker.viewmodel.RecurringExpenseViewModel
import com.example.expensetracker.viewmodel.SettingsViewModel
import com.example.expensetracker.viewmodel.UpcomingPaymentsViewModel
...
class MainActivity : AppCompatActivity() {
    private val recurringExpenseViewModel: RecurringExpenseViewModel by viewModels {
        RecurringExpenseViewModel.create((application as com.example.expensetracker.ExpenseTrackerApplication).repository)
    }
    private val upcomingPaymentsViewModel: UpcomingPaymentsViewModel by viewModels {
        UpcomingPaymentsViewModel.create((application as com.example.expensetracker.ExpenseTrackerApplication).repository)
    }
    private val settingsViewModel: SettingsViewModel by viewModels {
        SettingsViewModel.create(getDatabasePath(com.example.expensetracker.Constants.DATABASE_NAME).path)
    }
    private val userPreferencesRepository: UserPreferencesRepository by lazy {
        (application as com.example.expensetracker.ExpenseTrackerApplication).userPreferencesRepository
    }
...
fun MainActivityContent(
    ...
    val backupPathLauncher =
        rememberLauncherForActivityResult(
            contract = ActivityResultContracts.CreateDocument(com.example.expensetracker.Constants.BACKUP_MIME_TYPE),
        ) {
            ...
            NavHost(
                ...
                composable(BottomNavigation.Settings.route) {
                    SettingsScreen(
                        ...
                        onBackupClicked = {
                            backupPathLauncher.launch(com.example.expensetracker.Constants.DEFAULT_BACKUP_NAME)
                        },
                        onRestoreClicked = {
                            importPathLauncher.launch(arrayOf(com.example.expensetracker.Constants.BACKUP_MIME_TYPE))
                        },
...
private fun MainActivityContentPreview() {
    ...
    ExpenseTrackerTheme {
        Surface(
            ...
            MainActivityContent(
                weeklyExpense = "Ksh 4,00 ",
                monthlyExpense = "Ksh 16,00 ",
                yearlyExpense = "Ksh 192,00 ",
